...
export default function VerticalFeatureTabs() {
  return (
      ...
      <div className="relative p-6 md:p-16">
        ...
        <div className="relative z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
          ...
          <div className="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
            <h2 className="text-2xl text-gray-900 font-bold sm:text-3xl">
            ...
            >
              ...
              <button
                type="button"
                className="hs-tab-active:bg-white hs-tab-active:shadow-md hs-tab-active:hover:border-transparent text-start hover:bg-gray-100 focus:outline-hidden focus:bg-gray-200 p-4 md:p-5 rounded-xl active"
              ...
              >
                <span className="flex gap-x-6">
                  <svg
                    className="shrink-0 mt-2 size-6 md:size-7 hs-tab-active:text-primary-600 text-gray-900"
                  ...
                  <span className="grow">
                    <span className="block text-lg font-semibold hs-tab-active:text-primary-600 text-gray-900">
                      Advanced tools
                    </span>
              ...
              <button
                type="button"
                className="hs-tab-active:bg-white hs-tab-active:shadow-md hs-tab-active:hover:border-transparent text-start hover:bg-gray-100 focus:outline-hidden focus:bg-gray-200 p-4 md:p-5 rounded-xl"
        ...
        {/* End Overlapping background panel */}
      </div>
    </div>
  );
}